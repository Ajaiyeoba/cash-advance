...
$bur_user = $password = "";
$bur_user_err = $password_err = $login_err = "";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $bur_user,  $hashed_password);
...
<body>
    <header>
        ...
        <ul class="navmenu">
            ...
            <li><a href="bursary_login.php">Bursary</a></li>
        </ul>
        <div class="nav-btn">
        <a href="login.php" class="" id="log-btn">Bursary Login </a>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Don't have an account? <a href="bursary_reg.php">Sign up now</a>.</p>
        </form> -->
    </div>
    ...
    <p>Already Have an Account! <a href="bursary_reg.php">Register</a>.</p>     
</form>
            </div>
        </div>
    </section>
