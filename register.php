...
// $staff_id = $username_err = $email_err = $password_err = $confirm_password_err = "";
...
//     //     $email_err = "Email should be in correct format";
//     // }  
...
//         $staff_id_err = "Please enter your staff_id.";
//     } elseif(!preg_match('/^[a-zA-Z0-9_]+$/', trim($_POST["staff_id"]))){
//         $staff_id_err = "Staff ID should  only contain numbers.";
//     } 
//     // Validate password
...
//         $sql = "INSERT INTO users ( username, email, staff_id, password) VALUES (?, ?, ?, ?)";
         
//         if($stmt = mysqli_prepare($link, $sql)){
//             // Bind variables to the prepared statement as parameters
//             // mysqli_stmt_bind_param($stmt, "ssi", $param_username, $param_staff_id , $param_email, $param_password);
//             mysqli_stmt_bind_param($stmt, "ssss", $param_username, $param_staff_id, $param_email, $param_password);
